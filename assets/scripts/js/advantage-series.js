(function( $ ) {
    ...
    let Special_Interest_Groups = $('#Special_Interest_Groups');
        ...
        .on( "mouseenter", function() {
            ...
            TweenMax.fromTo([City_Dwellers],0.7,{y:30,repeat: 0,autoAlpha: 0},{y:0,ease:Back.easeOut,repeat: 0,autoAlpha:1})
        ...
        $(The_Media)
        .on( "mouseenter", function() {
            TweenMax.fromTo([The_Media],0.7,{y:30,repeat: 0,autoAlpha: 0},{y:0,ease:Back.easeOut,repeat: 0,autoAlpha:1})
